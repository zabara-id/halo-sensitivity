...
ORBIT_TYPE = "L1"
ORBIT_MIN, ORBIT_MAX = 1, 12
GRID_DENSITY = 20
SEED = 42
REUSE_NOISE = True
AMOUNT_OF_POINTS = 5_000

OUTPATH = "data/output/coefficients_wide/L1.csv"
...
def compute_one(orbit_number: int):
    ...
    (orbit_number, z0, alpha1, alpha2, n_perf, deviation_max_km)
    """
    try:
        _, z0, _, _, _, _ = initial_state_parser(ORBIT_TYPE, orbit_number)
